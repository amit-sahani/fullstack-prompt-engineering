      ...
      <main className="max-w-3xl mx-auto py-14 px-4">
        ...
        <section className="mb-10">
          <p className="text-lg text-[#F4E2D8] text-center mb-6">
            An{" "}
            <span className="text-[#FFD700] font-semibold">HTML element</span>{" "}
            is a fundamental building block of a webpage. It tells the browser
            how to display or interpret content.
          </p>
          ...
          <div className="bg-gradient-to-br from-[#232946] to-[#181C2B] rounded-xl shadow-lg p-6 border border-[#FFD700]/20 mb-6">
            ...
            <ol className="list-decimal pl-6 text-[#F4E2D8] space-y-3">
              ...
              <li>
                ...
                <span className="font-mono">Hello, world!</span> — The
                information or other elements placed between the opening and
                closing tags. This is what users see on the page.
              </li>
              <li>
                <span className="text-[#FFD700] font-semibold">
                  Closing Tag
                </span>
                : <span className="font-mono">&lt;/p&gt;</span> — Marks the end
                of the element.
              </li>
              <li>
                <span className="text-[#FFD700] font-semibold">Element</span>:
                The complete structure, including opening tag, content, and
                closing tag, forms the element.
              </li>
            </ol>
          </div>
          ...
          <div className="bg-gradient-to-br from-[#232946] to-[#181C2B] rounded-xl shadow-lg p-6 border border-[#FFD700]/20 mb-6">
            ...
            <ul className="list-disc pl-6 text-[#F4E2D8] space-y-2">
              ...
              <li>
                They tell the browser how to display or interpret different
                types of content (text, images, links, etc.).
              </li>
              <li>
                They allow developers to organize, style, and add interactivity
                to web pages.
              </li>
            </ul>
          </div>
          ...
          <div className="bg-gradient-to-br from-[#232946] to-[#181C2B] rounded-xl shadow-lg p-6 border border-[#FFD700]/20 mb-6">
            ...
            <p className="text-[#F4E2D8] mb-4">
              ...
              <span className="text-[#FFD700] font-semibold">nested</span>{" "}
              inside one another to create complex structures. However, some

      ...
      <main className="max-w-5xl mx-auto py-10 px-4">
        ...
        <section className="mb-10">
          <p className="text-lg text-[#F4E2D8] text-center mb-6">
            ...
            <span className="text-[#FFD700] font-semibold">attributes</span>{" "}
            that provide extra information about the element — like adding
            labels, colors, or settings. They’re written inside the opening tag
            and usually come in a{" "}
            <span className="font-mono">name="value"</span> format.
          </p>
          <div className="bg-gradient-to-br from-[#232946] to-[#181C2B] rounded-xl shadow-lg p-6 border border-[#FFD700]/20 mb-6">
            ...
            <ul className="list-disc pl-6 text-[#F4E2D8] space-y-1">
              <li>
                <span className="font-mono">title</span> is the attribute’s
                name.
              </li>
              <li>
                <span className="font-mono">"About Amit"</span> is the
                attribute’s value.
              </li>
              <li>
                When someone hovers over the paragraph, the text "About Amit"
          ...
          <div className="bg-gradient-to-br from-[#232946] to-[#181C2B] rounded-xl shadow-lg p-6 border border-[#FFD700]/20 mb-6">
            ...
            <p className="text-[#F4E2D8] mb-4">
              ...
              destination, and{" "}
              <span className="font-mono">target="_blank"</span> opens it in a
              new tab.
            </p>
            <p className="text-[#F4E2D8] mb-1 font-semibold">

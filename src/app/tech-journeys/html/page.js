    ...
    <>
      ...
      <section className="mb-10 bg-gradient-to-br from-[#232946] to-[#181C2B] rounded-xl shadow-2xl p-8 border-2 border-[#FFD700]/30">
        ...
        <p className="text-[#F4E2D8] text-base leading-relaxed">
          ...
          several versions, with HTML5 being the latest standard, providing new
      ...
      <section className="mb-10 bg-gradient-to-br from-[#232946] to-[#181C2B] rounded-xl shadow-2xl p-8 border-2 border-[#FFD700]/30">
        ...
        <p className="text-[#F4E2D8] text-base leading-relaxed">
          HTML is used to structure content on the web. Every website uses HTML
          to define headings, paragraphs, links, images, and other elements. It
          is the foundation of all web pages.
        </p>
      </section>
      {/* Navigation Links */}
